...
public class AcceptedOrdersAdapter extends ArrayAdapter<Orders> {

    Context con;
    public AcceptedOrdersAdapter(@NonNull Context context, @NonNull List<Orders> ordersList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        convertView = LayoutInflater.from(getContext()).inflate(R.layout.acceptedmedicineview, parent, false);

        final Orders orders =getItem(position);
        TextView medicineName = (TextView)convertView.findViewById(R.id.tvMedicineNameAccepted);
        TextView medicineQty = (TextView)convertView.findViewById(R.id.tvMedicineQtyAccepted);
        TextView ordernumb = (TextView)convertView.findViewById(R.id.tvOrderNumberAccepted);
