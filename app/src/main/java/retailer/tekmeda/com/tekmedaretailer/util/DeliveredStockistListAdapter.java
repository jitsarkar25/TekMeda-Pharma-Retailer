...
public class DeliveredStockistListAdapter extends ArrayAdapter<Stockists> {

    public DeliveredStockistListAdapter(@NonNull Context context, @NonNull List<Stockists> stockistsList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        convertView = LayoutInflater.from(getContext()).inflate(R.layout.deliveredstockistlistview, parent, false);

        Stockists stockists =getItem(position);
        TextView enterpriseName = (TextView)convertView.findViewById(R.id.tvStockistNameDelivered);
